/**
 * Applies supabase/apply_leave_requests_migration.sql to Postgres (same pattern as invite migration).
 */
...
const migrationPath = join(__dirname, "../supabase/apply_leave_requests_migration.sql");
