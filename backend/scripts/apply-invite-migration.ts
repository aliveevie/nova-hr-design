/**
 * Applies supabase/apply_invite_migration.sql to the configured Postgres (Aiven when PRODUCTION=true).
 */
...
const migrationPath = join(__dirname, "../supabase/apply_invite_migration.sql");
const migrationSql = fs.readFileSync(migrationPath, "utf8");

async function main() {
  console.log("Applying invite / ownership migration...");
