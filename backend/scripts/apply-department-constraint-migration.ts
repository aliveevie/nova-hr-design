/**
 * Applies supabase/apply_department_constraint_migration.sql to Postgres.
 */
...
const migrationPath = join(__dirname, "../supabase/apply_department_constraint_migration.sql");
const migrationSql = fs.readFileSync(migrationPath, "utf8");

async function main() {
  console.log("Applying department constraint migration...");
